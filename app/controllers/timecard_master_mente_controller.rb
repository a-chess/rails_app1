class TimecardMasterMenteController < ApplicationController
  ...
  #index追加
  def create
    base_month = TimeCardIndex.maximum(:target_month)
    ...
    begin
      ...
      Timecard.transaction do
          User.all.each do |user|
            ...
            if !Timecard.exists?(emp_id: user.emp_id, target_month: target_month)
              
              #TC登録
              tc = Timecard.new
              tc.emp_id = user.emp_id
